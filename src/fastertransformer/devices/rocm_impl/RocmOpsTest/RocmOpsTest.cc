#include "src/fastertransformer/devices/rocm_impl/tests/RocmTestUtils.h"
...
TEST_F(RocmOpsTest, testCopyWithSlicing) {
    using TestT = int32_t;
...
TEST_F(RocmOpsTest, testTranspose) {
...
/*
TEST_F(RocmOpsTest, testConvert) {
