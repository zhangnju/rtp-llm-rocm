...
#define DISPATCH_FOR_EACH_COMPUTE_TYPE(MACRO, ...)         \
    ...
    MACRO(DataType::TYPE_FP16, __half, __VA_ARGS__)          \
    default: \
        FT_CHECK(false);
//MACRO(DataType::TYPE_BF16, hip_bfloat16, __VA_ARGS__) 
...
#define DISPATCH_ROCM_FUNCTION_DATA_TYPE(data_type, function, ...)                              \
    do {                                                                                        \
        switch (data_type) {                                                                    \
...
#define DISPATCH_ROCM_FUNCTION_GENERAL_TYPE(data_type, function, ...)                           \
    do {                                                                                        \
        switch (data_type) {                                                                    \
...
#define DISPATCH_ROCM_FUNCTION_TWO_TYPES(dtype1, dtype2, function, ...)                      \
    switch (dtype1) {                                                                        \
        OUTER_TYPE_CASE(DataType::TYPE_FP16, __half, dtype2, function, __VA_ARGS__)            \
        OUTER_TYPE_CASE(DataType::TYPE_BF16, hip_bfloat16, dtype2, function, __VA_ARGS__)   \
